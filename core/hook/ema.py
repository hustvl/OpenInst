...
class BaseEMAHook(Hook):
    ...
    def before_run(self, runner):
        ...
        if self.checkpoint is not None:
            runner.resume(self.checkpoint, resume_optimizer=False) # !!!ban loading optimizer state_dict
...
class LExpMomentumEMAHook(BaseEMAHook):
    ...
    def __init__(self, total_iter=2000, **kwargs):
        super(LExpMomentumEMAHook, self).__init__(**kwargs)
