...
class COCOEvalWrapper(COCOeval):
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[1] = _summarize(0, iouThr=.5, maxDets=100)
            stats[2] = _summarize(0, iouThr=.75, maxDets=100)
            stats[3] = _summarize(0, areaRng='small', maxDets=100)
            stats[4] = _summarize(0, areaRng='medium', maxDets=100)
            stats[5] = _summarize(0, areaRng='large', maxDets=100)
            ...
            stats[11] = _summarize(0, maxDets=self.params.maxDets[5]) # 300
