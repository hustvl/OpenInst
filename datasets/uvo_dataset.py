...
class UVODataset(CocoDataset):
    ...
    def __init__(self, 
        ...
        assert train_class=='all' and eval_class=='all'
        self.is_class_agnostic = is_class_agnostic
        self.train_class = train_class
        self.eval_class = eval_class
        super(UVODataset, self).__init__(**kwargs)
        self.dataset_stat()
    
    CLASSES = ('object',) # for UVO dataset
    ...
    def evaluate(self,
                 ...
                 classwise=False,
                 proposal_nums=(10, 20, 30, 50, 100, 300),
                 iou_thrs=None,
                 metric_items=None):
