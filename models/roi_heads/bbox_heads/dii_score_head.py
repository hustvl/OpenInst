...
class DIIScoreHead(BBoxHead):
    ...
    def __init__(self,
        ...
        super(DIIScoreHead, self).__init__(
        ...
        # over load the self.fc_cls in BBoxHead. Only predict objectness score in OLN.
    ...
    def init_weights(self):
        ...
        super(DIIScoreHead, self).init_weights()
    ...
    def _get_target_single(self, pos_inds, neg_inds, pos_bboxes, neg_bboxes,
        ...
        labels = pos_bboxes.new_zeros(num_samples)
        label_weights = pos_bboxes.new_zeros(num_samples)
        bbox_targets = pos_bboxes.new_zeros(num_samples, 4)
        bbox_weights = pos_bboxes.new_zeros(num_samples, 4)
        if num_pos > 0:
            # Bbox-IoU as target
            iou_targets = bbox_overlaps(pos_bboxes, pos_gt_bboxes, is_aligned=True)
            labels[pos_inds] = iou_targets
